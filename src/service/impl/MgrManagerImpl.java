	...
	implements MgrManager
{
	 ...
	 * @param mgr 员工所属的经理
	 */
	public void addEmp(Employee emp , String mgr)throws Exception
	{
		Manager m = mgrDao.findByName(mgr);
		if (m == null)
		{
			throw new Exception("新增员工的业务异常");
		}
		emp.setManager(m);
		empDao.save(emp);
	}
	 ...
	 * @return 部门上个月工资
	 */
	public List<SalaryBean> getSalaryByMgr(String mgr) throws Exception
	{
		Manager m = mgrDao.findByName(mgr);
		if (m == null)
		{
			throw new Exception("您是经理吗？或你还未登录？");
		}
		//查询该经理对应的全部员工
	...
	* @return 经理的全部下属
	*/
	public List<EmpBean> getEmpsByMgr(String mgr) throws Exception
	{
		Manager m = mgrDao.findByName(mgr);
		if (m == null)
		{
	 ...
	 * @return 该部门的全部申请
	 */
	public List<AppBean> getAppsByMgr(String mgr)throws Exception
	{
		Manager m = mgrDao.findByName(mgr);
		if (m == null)
		{
